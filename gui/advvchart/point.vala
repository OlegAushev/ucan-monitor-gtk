...
{
	private Gee.ArrayList<Point?> _points = new Gee.ArrayList<Point?>();
	...
	public int size
	{
		get { return _points.size; }
	}

	public double realtime_delta { get; set; }

	public new Point get(int at) { return _points.get(at); }
	...
	public Point first() { return this.get(0); }
	public Point last() { return this.get(this.size - 1); }
	...
	private static Point value_to_point(TimestampedValue last_value,
			TimestampedValue current_value,
			Config config,
