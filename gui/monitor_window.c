...
static void monitor_window_class_init(MonitorWindowClass* klass)
{
	...
	gtk_widget_class_set_template_from_resource(widget_class, "/gui/monitor_window.ui");
	gtk_widget_class_bind_template_child(widget_class, MonitorWindow, header_bar);
